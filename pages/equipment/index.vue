<template>
  <view>
    ...
    <view class="uni-flex uni-column">
      <view class="bottomItem" @click="open()">
        <image class="image myImage" mode="widthFix" src="../../static/images/equ-leg1.png" />
        <view class="adap">
      ...
      <view class="bottomItem">
        <image class="image myImage" mode="widthFix" src="../../static/images/equ-leg2.png" />
        <view class="adap">
          <text class="centerText">HXZC-R3(20A)/变压器三相直流电阻测试仪</text>
          <view class="bottomText">
            <text>{{$t('notconnected')}}</text>
