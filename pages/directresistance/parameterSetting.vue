         ...
         <view class="uni-list bottomItem">
           <view class="uni-list-cell">
             ...
             <view class="uni-list-cell-db lineHang">
              <input class="uni-input"  type="number" style="text-align: right;" @input="replaceInput" v-model="changeValue" placeholder="请输入" />
             </view>
  ...
  export default {
    ...
    data() {
      return {
        ...
        indexModel: 0,
        arrayIe: [{ name:'Auto', value:'00 b6' },
                  { name:'<20mA', value:'01 b7' },
                  { name:'40mA', value:'02 b8' },
                  { name:'200mA', value:'03 b9' },
                  { name:'1A', value:'04 ba' },
                  { name:'3A', value:'05 bb' },
                  { name:'10A', value:'06 bc' }],
        indexIe: 0,
        arrayMu: ['AB', 'BC', 'CA', 'AO', 'BO', 'CO', 'AmBm', 'Bmcm', 'CmAm', 'AmOm', 'BmOm', 'CmOm', 'ab', 'bc', 'ca', 'ao', 'bo', 'co'],
        indexMu: 0,
        arrayRZ: ['0.0', '1.1', '2.2'],
        indexRZ: 0,
          arrayZS: ['铜', '铝'],
